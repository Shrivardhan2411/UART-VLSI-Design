set log file fv/uart_top/rtl_to_g1.log -replace
...
vpx read guide file fv/uart_top/rtl_to_g1.ovf
...
add search path -library /home/buet/Desktop/UART/library
read library -statetable -liberty -both  \
	fast.lib \
	typical.lib \
	slow.lib

add search path -design /home/buet/Desktop/UART
read design  -verilog2k -define SYNTHESIS  -golden -lastmod -noelab \
	/home/buet/Desktop/UART/uart_top.v \
	/home/buet/Desktop/UART/transmitter.v \
	/home/buet/Desktop/UART/uart_reciver.v \
	/home/buet/Desktop/UART/baud_rate_generator.v

elaborate design -golden -root uart_top -rootonly

read design -verilog -revised -lastmod -noelab \
	-unzip fv/uart_top/g1.v.gz

elaborate design -revised -root uart_top
...
write hier_compare dofile fv/uart_top/hier_rtl_to_g1.do \
...
run hier_compare fv/uart_top/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
